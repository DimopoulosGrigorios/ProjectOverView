package com.example.gnt_trainee_project;
 ...
 */
public class Gnt_trainee_projectTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/Gnt_trainee_project");
    }
